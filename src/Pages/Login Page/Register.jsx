...
const Register = () => {
  ...
  return (
    <div className='container'>
      ...
      <form action="" method='post' className='d-flex flex-column gap-4 w-75 mx-auto'><input name="email" className='form-control' placeholder="Email" onChange={handleChange} />
